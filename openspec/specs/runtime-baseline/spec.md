...
Boots the Node/Express server with a health endpoint, structured logging, and a testable app factory so every downstream change (Temporal, agents, integrations) has a runnable skeleton to build on.
