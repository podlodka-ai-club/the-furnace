...
- [x] `review-agent` — Single reviewer activity with one verdict and reasoning payload over the coder diff
- [x] `github-adapter` — Open PR after review passes; attach structured workflow trailers for traceability
